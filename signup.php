        ...
        <form action="includes/signup.inc.php" method="POST" >
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" name="student_roll_no" placeholder="USN" required="required" autocomplete="off"
                    onchange="u_validation()"  id="usn" />
                </div>
            </div>
            <div class=" w3l-form-group">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control" name="mobile_no" placeholder="Mobile No" required="required" id="mobile"
                    onchange="m_validation()" />
                </div>
            </div>
            <div class=" w3l-form-group">
            ...
            <div class=" w3l-form-group">
                ...
                <div class="group">
                    ...
                    <input type="password" class="form-control" name="pwd" placeholder="Password" required="required" id="password"
                    onchange="p_validation()" />
                </div>
            </div>
