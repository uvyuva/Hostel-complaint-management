	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home_manager.php"><img src="./web_home/images/aiet-logo.png" alt="logo" width="70px" height="70px"   > <span class="display"></span></a></h1>
				...
				<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
					...
					<!-- <li class="dropdown nav-item">
						...
						<li class="nav-item active">
							<a class="nav-link" href="contact.php">Update to Student</a>
						</li>
						<li class="dropdown nav-item">
...
<section class="contact py-5">
	<div class="container">
		<h2 class="heading text-capitalize mb-sm-5 mb-4"> Reply to Students </h2>
				...
				<form action="contact_manager.php" method="post">
					<div class="row">
						<div class="col-md-6 contact_left_grid" data-aos="fade-right">
							...
							<div class="contact-fields-w3ls">
								<input type="text" name="student_roll_no" placeholder="Student USN" required="">
							</div>
							<div class="contact-fields-w3ls">
